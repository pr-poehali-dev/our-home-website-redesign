...
export default function Index() {
        ...
        return (
          <>
            <section className="relative pt-32 pb-20 px-6 overflow-hidden">
              ...
              <Icon name="Home" className="absolute top-40 right-1/4 text-white/20 blur-[1px]" size={32} />
              <Icon name="Home" className="absolute top-60 right-1/3 text-white/30" size={20} />
              <Icon name="Home" className="absolute bottom-40 left-1/4 text-white/15 blur-[2px]" size={40} />
              <Icon name="Home" className="absolute top-1/2 right-20 text-white/25" size={24} />
            ...
            <section className="py-16 px-6 relative">
              <Icon name="Home" className="absolute top-10 left-10 text-white/10 blur-sm" size={80} />
              <Icon name="Home" className="absolute bottom-10 right-10 text-white/15" size={60} />
            ...
            <section className="py-24 px-6 relative">
              <Icon name="Home" className="absolute top-20 left-1/4 text-white/15" size={28} />
              <Icon name="Home" className="absolute bottom-20 right-1/4 text-white/20 blur-[1px]" size={36} />
              <div className="max-w-7xl mx-auto">
            ...
            <section className="py-24 px-6 relative">
              <Icon name="Home" className="absolute top-1/2 left-10 text-white/12 blur-sm" size={72} />
              <Icon name="Home" className="absolute bottom-1/3 right-20 text-white/18" size={56} />
              <div className="max-w-7xl mx-auto">
  ...
  return (
    <div className="min-h-screen bg-background">
      <header className="fixed top-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-xl border-b border-border shadow-lg">
